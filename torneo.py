...
squadre = [
    "ZOCCHI", "BARCHI", "MATTIUZ", "ABRUSCATO", "DESSILANI", "CHIESA", "MUCCINO", "BALZANO", "IACOMETTI", "SARONNE", "COMOLLA", "TAGLIABUE", "SANTEUSANIO", "PEZZOTTA", "PANELLA", "MARI", "PERONI", "TOMOVA", "OLMO", 
 "INVERNIZZI", "DIVITTORIO", "DELSIGNORE", "BEMBO", "IMPALONI", "PEZZANA", "GIANCOLA", "STANGALINI"]
